...
public class Problem_mirror_CDL_11 extends Problem
{


    public Problem_mirror_CDL_11(int numberOfElements, int[] input, String problemDescription )
    {
        super(numberOfElements, input, problemDescription);
    }

    public Problem_mirror_CDL_11(Problem problem) {
    ...
    public  String toString()
    {
        ...
        return problemDescription + ": " + "numberOfElements=" + numberOfElements + ", input=" + arrayDisplay;
    }
