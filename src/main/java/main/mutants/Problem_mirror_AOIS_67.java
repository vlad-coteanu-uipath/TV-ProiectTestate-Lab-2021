...
public class Problem_mirror_AOIS_67 extends Problem
{


    public Problem_mirror_AOIS_67(int numberOfElements, int[] input, String problemDescription )
    {
        super(numberOfElements, input, problemDescription);
    }

    public Problem_mirror_AOIS_67(Problem problem) {
