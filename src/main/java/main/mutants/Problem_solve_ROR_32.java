...
public class Problem_solve_ROR_32 extends Problem
{

    public Problem_solve_ROR_32(int numberOfElements, int[] input, String problemDescription )
    {
        super(numberOfElements, input, problemDescription);
    }

    public Problem_solve_ROR_32(Problem problem) {
