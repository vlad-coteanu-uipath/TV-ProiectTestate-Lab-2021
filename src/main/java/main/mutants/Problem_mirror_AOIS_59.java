...
public class Problem_mirror_AOIS_59  extends Problem
{

    public Problem_mirror_AOIS_59(int numberOfElements, int[] input, String problemDescription )
    {
        super(numberOfElements, input, problemDescription);
    }

    public Problem_mirror_AOIS_59(Problem problem) {
