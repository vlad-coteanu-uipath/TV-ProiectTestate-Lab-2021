...
public class Problem_solve_AOIU_5 extends Problem
{

    public Problem_solve_AOIU_5( int numberOfElements, int[] input, String problemDescription )
    {
        super(numberOfElements, input, problemDescription);
    }

    public Problem_solve_AOIU_5(Problem problem) {
