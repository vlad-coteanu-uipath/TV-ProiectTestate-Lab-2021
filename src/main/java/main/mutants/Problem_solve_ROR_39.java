...
public class Problem_solve_ROR_39 extends Problem
{

    public Problem_solve_ROR_39( int numberOfElements, int[] input, String problemDescription )
    {
        super(numberOfElements, input, problemDescription);
    }

    public Problem_solve_ROR_39(Problem problem) {
